      ...
      <div v-if="activeStep">
        ...
        <div class="space-y-4 property-editor">
          <div v-if="activeStep.type === 'Send Email'">
            <div>
              <label>Subject</label>
              <input type="text" :value="activeStep.props.subject" @input="updateProp('subject', $event.target.value)" />
            </div>
            <div>
              <label>Body</label>
              <textarea :value="activeStep.props.body" @input="updateProp('body', $event.target.value)"></textarea>
            </div>
          </div>
          ...
          <div v-else-if="activeStep.type === 'Send WhatsApp'">
            <div>
              ...
              <input type="text" :value="activeStep.props.phone" @input="updateProp('phone', $event.target.value)" />
            </div>
            <div>
              <label>Message</label>
              <textarea :value="activeStep.props.message" @input="updateProp('message', $event.target.value)"></textarea>
            </div>
          </div>
          </div>
